...
public class ProductService {
    public List<SampleProduct> search() {
        ...
        Arrays.asList(
            ...
            new SampleProduct("A-10", "試作品X-290PA1", 10, true, true),
            new SampleProduct("A-20", "試作品X-290PA2", 20, true, true),
            new SampleProduct("B-30", "試作品X-B3", 10, true, true),
            new SampleProduct("B-40", "試作品X-B4", 30, true, true),
            new SampleProduct("C-50", "試作品X-C5", 10, true, false),
            new SampleProduct("C-60", "試作品X-C6", 40, true, false),
            new SampleProduct("D-70", "試作品X-D7", 10, false, true),
            new SampleProduct("D-80", "試作品X-D8", 50, false, true),
            new SampleProduct("E-90", "試作品X-E9", 10, true, true),
